...
> [!NOTE]
> This functionality is now available as an official [Add-on Display Light](addon_display_light.md).
> If you have this added as a customization, please remove it and use the add-on instead for official support and updates.
